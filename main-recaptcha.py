...
Version 1.5.12-reCAPTCHA - 2022, 06 March.
    ...
    def upload(self) -> bool:
        ...
        try:  # Go to the OpenSea create URL and input all datas of the NFT.
            ...
            try:  # Wait for the reCAPTCHA to be displayed.
                ...
                print(f'{yellow}Waiting for user to solve reCAPTCHA.{reset}',
                      end=' ')  # When solved, webpage changes.
            except Exception:  # reCAPTCHA is not visible.
                raise TE('Failed at reCAPTCHA.')
            WDW(web.driver, 120).until(lambda _: web.driver.current_url !=
...
if __name__ == '__main__':
    ...
    print('\n===================================================='
          f'\n{yellow}This version provide a temporary solution to solve'
          f'\nreCAPTCHAs: you have to do it manually in 2 minutes.{reset}'
          '\n====================================================')
