...
➜ **[Version 1.8.2](#version-182)** (June 16, 2022).
...
https://user-images.githubusercontent.com/91475935/173585936-e36a1109-f570-4fca-bcfd-20c2da6ed167.mp4
...
**➜ In addition, watch this video on YouTube: [How to install and setup the tool?](https://www.youtube.com/watch?v=jtERa6i9e1k)**
...
**➜ In addition, watch this video on YouTube: [How to create my metadata file?](https://www.youtube.com/watch?v=67eRggoadOQ)**  
...
And it gives you something like this: [JSON](https://github.com/maximedrn/opensea-automatic-bulk-upload-and-sale/blob/master/data/examples/json_structure_upload_and_sale.json), [CSV](https://github.com/maximedrn/opensea-automatic-bulk-upload-and-sale/blob/master/data/examples/csv_structure_upload_and_sale.csv), [XLSX (must be downloaded to view it)](https://github.com/maximedrn/opensea-automatic-bulk-upload-and-sale/blob/master/data/examples/xlsx_structure_upload_and_sale.xlsx).
 
## "Upload only" metadata file

<details>
    <summary><strong>Display the table.</strong></summary>
    <br />
    <table>
        <tbody>
            <tr>
...
And it gives you something like this: [JSON](https://github.com/maximedrn/opensea-automatic-bulk-upload-and-sale/blob/master/data/examples/json_structure_upload_only.json), [CSV](https://github.com/maximedrn/opensea-automatic-bulk-upload-and-sale/blob/master/data/examples/csv_structure_upload_only.csv), [XLSX (must be downloaded to view it)](https://github.com/maximedrn/opensea-automatic-bulk-upload-and-sale/blob/master/data/examples/xlsx_structure_upload_only.xlsx).
...
And it gives you something like this: [JSON](https://github.com/maximedrn/opensea-automatic-bulk-upload-and-sale/blob/master/data/examples/json_structure_sale_only.json), [CSV](https://github.com/maximedrn/opensea-automatic-bulk-upload-and-sale/blob/master/data/examples/csv_structure_sale_only.csv), [XLSX (must be downloaded to view it)](https://github.com/maximedrn/opensea-automatic-bulk-upload-and-sale/blob/master/data/examples/xlsx_structure_sale_only.xlsx).
...
With this Multiprocessing tool, you can upload and list your NFTs **two to five times faster**.
It splits your file into several subfiles, then command prompts open and work like the main bot but at the same time.  
...
<details>
  <summary><strong>Display the repository structure.</strong></summary>
  <br />
 ...
 * Correction of the file `divide.py`.

<details>
  <summary>Earlier versions.</summary>

### Versions 1.8.1 and 1.8.1.1:
 ...
 * Improved the detection of listed NFTs.  **[#319](https://github.com/maximedrn/opensea-automatic-bulk-upload-and-sale/issues/319)**.
 * Removed the 404 page error check for the upload that causes a duplicate upload.  **[#319](https://github.com/maximedrn/opensea-automatic-bulk-upload-and-sale/issues/319)**.
